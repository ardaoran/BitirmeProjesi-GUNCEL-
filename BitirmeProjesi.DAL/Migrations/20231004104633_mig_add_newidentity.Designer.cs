...
namespace BitirmeProjesi.DAL.Migrations
{
    ...
    [Migration("20231004104633_mig_add_newidentity")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BitirmeProjesi.DAL.Entities.Admin", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = 1,
                            LastLoginIP = "",
                            LastLongDate = new DateTime(2023, 10, 4, 13, 46, 33, 124, DateTimeKind.Local).AddTicks(1947),
            ...
            modelBuilder.Entity("BitirmeProjesi.DAL.Entities.AppRole", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BitirmeProjesi.DAL.Entities.AppUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<int>", b =>
                {
                    b.HasOne("BitirmeProjesi.DAL.Entities.AppRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("BitirmeProjesi.DAL.Entities.AppUser", null)
                        .WithMany()
